      ...
      <div className="text-center max-w-lg mx-auto px-6">
        ...
        <div className="relative mb-10">
          <div className="w-32 h-32 mx-auto bg-gradient-to-br from-primary-light/10 to-accent-light/10 dark:from-primary-dark/10 dark:to-accent-dark/10 rounded-[2.5rem] flex items-center justify-center relative overflow-hidden group">
            ...
            <BookOpen className="w-16 h-16 text-primary-light dark:text-primary-dark relative z-10 group-hover:scale-110 transition-transform duration-500" />
          </div>
        ...
        <p className="text-gray-500 dark:text-gray-400 text-lg font-medium mb-8 leading-relaxed">
          The Study Hub is getting a major upgrade. Curated resources, smart recommendations, and your personalized learning dashboard — all arriving soon.
        </p>

        {/* Feature Teaser */}
        <div className="flex items-center justify-center gap-4 mb-8">
          <div className="flex items-center gap-2 px-4 py-2 bg-white dark:bg-subtle-dark rounded-2xl border border-gray-100 dark:border-white/5 shadow-sm">
            <Sparkles className="w-4 h-4 text-yellow-500" />
            <span className="text-xs font-bold text-gray-600 dark:text-gray-300">Smart Notes</span>
          </div>
          <div className="flex items-center gap-2 px-4 py-2 bg-white dark:bg-subtle-dark rounded-2xl border border-gray-100 dark:border-white/5 shadow-sm">
            <Sparkles className="w-4 h-4 text-blue-500" />
            <span className="text-xs font-bold text-gray-600 dark:text-gray-300">Video Lessons</span>
          </div>
          <div className="flex items-center gap-2 px-4 py-2 bg-white dark:bg-subtle-dark rounded-2xl border border-gray-100 dark:border-white/5 shadow-sm">
            <Sparkles className="w-4 h-4 text-green-500" />
            <span className="text-xs font-bold text-gray-600 dark:text-gray-300">Past Questions</span>
          </div>
        </div>
